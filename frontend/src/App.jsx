...
<title>Trainr Report – ${current.modelName}</title>
<style>
...
<h1>Trainr Report</h1>
<p class="subtitle">Generated by Trainr · ${new Date(current.timestamp).toLocaleString()}</p>
...
${pca.length > 0 ? `<div class="card">
  ...
  <p class="note">${pcaNote}</p>
    ...
    const a    = document.createElement('a');
    a.href = url;
    a.download = `trainr_report_${current.modelId}_${Date.now()}.html`;
    a.style.display = 'none';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
  ...
  ${cmHtml}
    ...
    const html = `<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"/>
<title>Trainr — Comparison Report</title>
<style>
...
<h1>Trainr — Model Comparison Report</h1>
...
${modelCards}
    ...
    const a    = document.createElement('a');
    a.href = url;
    a.download = `trainr_comparison_${Date.now()}.html`;
    a.style.display = 'none';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
  ...
  return (
    <header style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 10, flexShrink: 0 }}>
        ...
        <span className="glitch-logo" data-text="Trainr" style={{ fontSize: 16 }}>Trainr</span>
      </div>
